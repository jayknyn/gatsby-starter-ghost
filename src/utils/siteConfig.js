module.exports = {
    ...
    siteTitleMeta: `Jay Kannaiyan's Website built with Ghost`, // This allows an alternative site title for meta data for pages.
    ...
    shortTitle: `JK Blog`, // Used for App manifest e.g. Mobile Home Screen
